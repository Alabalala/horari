...
const translations = {
  en: {
    ...
    startingBalance: 'Balance carried from previous months',
    priorMonths: 'Previous months',
    monthContract: 'Month contract hours',
    monthWorked: 'Month actual hours',
  ...
  es: {
    ...
    asOfDate: 'Hasta la fecha',
    fullMonth: 'Mes completo',
    startingBalance: 'Saldo arrastrado de meses anteriores',
    priorMonths: 'Meses anteriores',
    monthContract: 'Horas de contrato del mes',
    monthWorked: 'Horas reales del mes',
